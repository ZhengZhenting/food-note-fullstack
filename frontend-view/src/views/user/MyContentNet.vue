    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 5px;">
            <el-row style="display: flex;justify-content: left;gap: 6px;">
                ...
                <el-input size="small" style="width: 226px;" v-model="contentNetQueryDto.accessCode"
                    placeholder="access code" clearable @clear="handleFilterClear">
...
export default {
    ...
    methods: {
        ...
        handleEdit(row) {
            this.contentNet = row;
            if (row.validDay === -1) {
                this.contentNet.validDay = 'Always';
            } else {
                this.contentNet.validDay = row.validDay + 'Days';
            }
