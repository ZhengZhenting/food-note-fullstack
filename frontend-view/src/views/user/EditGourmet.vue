<template>
    <div class="container">
        <div class="top">
            ...
            <span class="text">Modify Gourmet</span>
        </div>
        <div class="bottom">
            <div style="background-color: rgb(255,255,255);">
                ...
                <div style="display: flex; justify-content: left; align-items: center; gap: 20px; line-height: 100px;">
                    ...
                    <el-select style="width: 200px;" size="small" v-model="gourmet.categoryId" placeholder="category"
                        clearable>
                ...
                <div style="margin-block: 30px;">
                    <el-button @click="updateGourmet" plain>MODIFY</el-button>
                </div>
            </div>
        </div>
