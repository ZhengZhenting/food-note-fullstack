<template>
    <div style="box-sizing: border-box;overflow-y: hidden;overflow-x: hidden;">
        <el-row>
                ...
                <div>
                    ...
                    <div>
                        <div style="padding: 20px 60px;box-sizing: border-box;">
                            <LineChart height="280px" tag="Content Sharing" @on-selected="netItemSelected" :values="shareValues"
                                :date="shareDates" />
                        </div>
                        <div style="padding: 20px 60px;box-sizing: border-box;">
                            <LineChart height="280px" tag="Gourmets" @on-selected="gourmetItemSelected"
            ...
            <el-col :span="8">
                <div class="buttom">
                    <p style="font-size: 24px;">Popoular Gourmets</p>
                    <div class="gourmet-item" v-for="(gourmet, index) in gourmetList" :key="index">
                        ...
                        <div class="right">
                            ...
                            <div class="info">
                                ...
                                <span>
                                    Like({{ gourmet.upvoteCount}})
                                </span>
                                <span>
                                    View({{ gourmet.viewCount }})
                                </span>
                                <span>
                                    Save({{ gourmet.saveCount }})
                                </span>
                            </div>
                        </div>
                    </div>
